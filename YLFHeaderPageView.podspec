#
# Be sure to run `pod lib lint YLFHeaderPageView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of YLFHeaderPageView.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'YLFHeaderPageView' => ['YLFHeaderPageView/Assets/*.png']
  # }
